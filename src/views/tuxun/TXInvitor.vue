          ...
          if (this.panoId !== this.lastRound.panoId || this.round !== this.lastRound.round) {
            ...
            setTimeout(function () {
                if (!this.viewer) {
                  ...
                  loadScript('https://i.chao-fan.com/streetview/js-tuxun-v2.js').then(() => {
                    ...
                    this.viewer.addListener('status_changed', () => {
                      ...
                      if (this.viewer.getStatus() && this.viewer.getStatus() !== 'OK') {
                        api.getByPath("/api/v0/tuxun/client/report", {panoId: this.viewer.getPano(), status: this.viewer.getStatus(), page: 'tuxun_invitor'}).then(res => {
                        });
                      }
                    });
