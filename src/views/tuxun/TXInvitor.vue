          ...
          if (this.panoId !== this.lastRound.panoId || this.round !== this.lastRound.round) {
            ...
            setTimeout(function () {
                if (!this.viewer) {
                  ...
                  loadScript('https://i.chao-fan.com/st_v3/js_v16.js').then(() => {
    ...
    goTuxun() {
      if (this.gameData.move) {
        ...
        if (this.gameData.pan) {
          ...
          if (this.gameData.china) {
            location.href = 'https://tuxun.fun/china-match?from=npmz'
          } else {
            location.href = 'https://tuxun.fun/world-match?from=npmz'
          }
        }
      }
