<template>
  <div class="container">
    ...
    <div class="rank-section" v-if="this.userProfile">
      <div @click="toDoc" style=" cursor: pointer; font-weight: bolder; margin: 0 auto; width: 100%; padding-bottom: 1rem; text-align: center">1月1日新赛季开始，数据重置</div>
...
export default {
  ...
  methods: {
    ...
    toHistory() {
      tuxunJump('https://tuxun.fun/activities?userId=' + this.userId + '&v=1118');
    },
    toAnalysis() {
      tuxunJump('https://tuxun.fun/user/analysis?v=1118');
    },
